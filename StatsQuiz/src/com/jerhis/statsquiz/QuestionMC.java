...
public class QuestionMC extends Question {
    ...
    private String getMCQuestion(int n) {
        switch (n) {
            ...
            case 3: return "8#An individual about whom or which we have data#subject#predicate#unit#adverb#explanation new line";
            ...
            case 9: return "8#Shows how a whole divides into categories by showing a wedge of a circle whose area corresponds to the proportion in each category#pie chart#box plot#box plot#distribution#explanation new line";
            ...
            case 13: return "8#When averages are taken across different groups, they can appear to contradict the overall averages#simpson's paradox#montezuma's revenge#newland's banana rule#euler’s rule#explanation new line";
